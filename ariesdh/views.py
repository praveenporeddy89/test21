...
def curam(request):
    ...
    connection_string = "DefaultEndpointsProtocol=https;AccountName=dohdpawu2devariesopssa01;AccountKey=g9s/VeoRMtsv7CHhbTJ4WwFOCBOwsX1Ghl2nROcihXs7yAt6NhXTZb7vTNN51JuVRBPbbLnGioQj+AStHQvD0Q==;EndpointSuffix=core.windows.net"
    ...
    with open('dashboard_file_contents.txt','r') as file:
        to_return = []
